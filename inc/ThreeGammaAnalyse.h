#ifndef __ThreeGammaAnalyse_h__
#define __ThreeGammaAnalyse_h__
...
class	ThreeGammaAnalyse  : public PPhysics
{
protected:
    TH1F*	time1;
    TH1F*	time_prompt;
...
HistoManu2 *Check_PSA_proton_3ped;

...
int main(int argc, char *argv[])
{
    ...
    // Create instance of PPi0Analyse.h class
    PPi0Analyse* ppi0 = new PPi0Analyse;
    ...
    {
        cout << "ERROR: PPi0Analyse.h Init failed!" << endl;
        return 0;
    }
    ...
    if(file_in.length() > 0)
    {
        ...
        if(length >= 5)
        {
            ...
            if(!ppi0->StartFile(file_in.c_str(), file_out.c_str())) cout << "ERROR: PPi0Analyse.h failed on file " << file_in << "!" << endl;
            files_found++;
        }
    }
